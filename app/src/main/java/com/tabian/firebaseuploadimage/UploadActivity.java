        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!name.equals("")){
                    ...
                    StorageReference storageReference = mStorageRef.child("images/users/" + userID + "/" + name + ".png");
...
/*    private void addFilePaths(){
    ...
    private void addFilePaths(){
        Log.d(TAG, "addFilePaths: Adding file paths.");
        pathArray.add("/sdcard/Pictures/Image1.png");
        pathArray.add("/sdcard/Pictures/Image2.png");
        pathArray.add("/sdcard/Pictures/Image3.png");
        loadImageFromStorage();
    }
